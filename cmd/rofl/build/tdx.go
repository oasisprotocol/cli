...
const (
	...
	defaultFirmwareUri       = "https://github.com/oasisprotocol/oasis-boot/releases/download/v0.1.0/ovmf.tdx.fd"
	defaultKernelUri         = "https://github.com/oasisprotocol/oasis-boot/releases/download/v0.1.0/stage1.bin"
	defaultStage2TemplateUri = "https://github.com/oasisprotocol/oasis-boot/releases/download/v0.1.0/stage2-basic.tar.bz2"
)

var knownHashes = map[string]string{
	defaultFirmwareUri:       "db47100a7d6a0c1f6983be224137c3f8d7cb09b63bb1c7a5ee7829d8e994a42f",
	defaultKernelUri:         "b8180d547a06abbb50529266c1bef88bd99a8bf266c155e36699864162c53ecc",
	defaultStage2TemplateUri: "c0b110b5749db6b1e3a281ec197111d309111809cab373f9ab01b5105bd2d239",
}
			...
			comp := bundle.Component{
				...
				TDX: &bundle.TDXMetadata{
					...
					ExtraKernelOptions: []string{
						...
						fmt.Sprintf("oasis.stage2.hash_offset=%d", rootfsSize*1024),
					},
