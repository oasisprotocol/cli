...
var showCmd = &cobra.Command{
	...
	Run: func(_ *cobra.Command, args []string) {
		...
		fmt.Printf("Name:       %s\n", machineName)
		fmt.Printf("Provider:   %s\n", common.PrettyAddressFromNative(npa.Network, insDsc.Provider))
		fmt.Printf("ID:         %s\n", insDsc.ID)
		fmt.Printf("Offer:      %s\n", insDsc.Offer)
		fmt.Printf("Status:     %s\n", insDsc.Status)
		fmt.Printf("Creator:    %s\n", common.PrettyAddressFromNative(npa.Network, insDsc.Creator))
		fmt.Printf("Admin:      %s\n", common.PrettyAddressFromNative(npa.Network, insDsc.Admin))
