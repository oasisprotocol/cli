...
// SupportsEthAddress returns true iff the account can have a corresponding Ethereum address.
func (a *Account) SupportsEthAddress() bool {
	rawAlg, ok := a.Config["algorithm"]
	if !ok {
		return false
	}
